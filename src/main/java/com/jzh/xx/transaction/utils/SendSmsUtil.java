...
public class SendSmsUtil {
     ...
     * 阿里云短信 accesskey_id
     */
    private static final String ACCESSKEYID = "LTAI5tM3WUNi5PEYVJDkjfD2";

    /**
     * 阿里云短信 secret
     */
    private static final String SECRET = "NqUlhVusMutvVVVJKlgYFm4jDQ4EXi";
...
//        String numeric = String.valueOf((int)((Math.random() * 9 + 1) * 100000));
        String numeric = String.valueOf((int)(123456));
